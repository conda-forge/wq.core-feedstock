About wq.core-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wq.core-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/wq/wq.core

Documentation: https://wq.io/1.0/docs/wq
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5868&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wq.core-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wq.core` can be installed with `conda`:
...
```
mamba install wq.core
```

It is possible to list all of the versions of `wq.core` available on your platform with `conda`:
...
```
mamba search wq.core --channel conda-forge
```
...
mamba repoquery search wq.core --channel conda-forge

# List packages depending on `wq.core`:
mamba repoquery whoneeds wq.core --channel conda-forge

# List dependencies of `wq.core`:
mamba repoquery depends wq.core --channel conda-forge
```
